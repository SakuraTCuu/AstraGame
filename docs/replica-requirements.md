...
| Automatic navigation | A*, overview POI and source quest destinations, transactional failed redirects, manual resume, blocking fog-gate approach and post-payment continuation | Match original route markers and resume timing; verify long routes across all regions |
| Multiple characters | Eight rank-gated positions, owned-hero deployment/swaps, explicit fragment activation, speed-bounded collision-aware follow, surviving leader selection, per-position equipment and table-driven levels | Complete remaining hero skill/art adapters; compare the local 1.21 catch-up tuning, roster changes and companion/pet behavior |
| Skills and damage | Source timelines, projectiles, persistent areas, percentage defense, inward displacement, hit/tick limits, compound costs/charges, periodic effects, traits, cleansing, knockback and defensive states; actionless definitions fail closed | Calibrate costs, charge semantics/persistence, hitboxes and timing; complete percentage limits, shield-break mechanics, multi-shot/random layouts, conditional area attributes, other effects and the overall defense/critical formula |
| Boss and normal enemies | Source first-Boss attacks, charge, jump and HP gate; armor caps, poison/following areas and bounded channels; bounded 5001603 fixed summons with two source templates | Complete other summon/pre-summon families, random/moving scene-object patterns, conditional modifiers, damage limits, health-layer counts and missing presentation |
| State machines | Independent Buff/state timers; stun, freeze, root, silence, airborne and fear control; visual lift phases and collision-aware random movement; separate control/displacement/interruption immunity; actor/cast/travel/run and recovery states | Calibrate airborne height/easing and fear heading intervals; complete directional flight and other specialized states, existing-control immunity interactions and exact interruption boundaries; verify revival rules, restore in-progress enemy combat and extend long-session checks |
| Zhushen/H5 foundation | Actual host UI/storage/resource/message managers exercised in isolation; production protocol is mandatory; role-scoped active-run lease and v2 phased delivery handle retry/reopen races in one process | Integrate into the production checkout and verify full startup, real protocol idempotency/timeouts, live account and reconnect behavior |
...
Team experience follows item 7 rewards and the configured PlayerLevel thresholds. A natural first-Boss run advanced from level 1 to 2 with 40/600 experience, and restored those values from a save. Kill counters support multi-kill and monster-subtype prerequisites. The journal adds mainline/first-kill reward claims and ordered rank promotion, with nine mainline steps, equipment assignment and the first promotion verified through natural gameplay. Basic hero upgrades consume configured merit and honor rank caps. Ordinary recruitment consumes vouchers and uses source reward weights and a persistent guarantee curve. `RepeatRand` first drops now choose one weighted option, and fragments can explicitly activate a hero with an atomic configured cost. Combined recruitment probabilities still need live comparison. Rename, duplicate conversion, star growth, recruitment wishlists and other-mode actions remain absent; their conditions remain enforced.

The roster contains 44 source profiles, of which 33 are initially visible and 26 have deployable skill/art adapters. Positions five through eight require ranks 4, 10, 19 and 28. Browser validation used explicit rank/card and fragment fixtures; it does not demonstrate naturally reaching rank 4 or acquiring those fragments. Source portraits, activation controls, live formation changes, reserve health/energy and reload restoration were inspected. The initial owned heroes remain the four comparison characters, independent of the observed account.

Still unconfirmed or incomplete: the overall defense and critical formulas, specialized source skill actions/modifiers, star attribute and skill replacement semantics, dynamic attribute scaling, exact Boss health layers, death/revival, other main-world maps and original route/formation timing. The comparison party uses source level-10 attributes; it remains separate from the live account.
