...
| Skills and damage | Source timelines, projectiles, separate energy gains, periodic stacking/settlement, personal traits, conditional healing, target bonuses, additional skills, NPC-debuff cleansing, impact knockback and self recovery | Verify live energy/trigger/impact timing; complete specialized actions, remaining conditional/team buffs, effect playback and defense/critical formulas |
