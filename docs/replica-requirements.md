...
| Skills and damage | Source timelines, projectiles, persistent area damage/healing and atlas playback, hit/tick limits, compound costs and charges, periodic effects, traits, cleansing, knockback and defensive states | Calibrate costs, charge semantics/persistence, hitboxes and timing; complete other resources, percentage limits, shield-break mechanics, multi-shot/random layouts, conditional area attributes, other effects and defense/critical formulas |
| Boss and normal enemies | Source first-Boss attacks, charge, jump and HP gate; armor caps, untargetable selection, poison pools, following areas and bounded channel turning; natural first-Boss run completed with three survivors | Complete random/moving scene-object patterns, conditional area modifiers, other Boss mechanics, damage limits and health-layer counts |
