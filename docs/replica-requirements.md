...
| Skills and damage | Source timelines, projectiles and atlas playback, hit budgets/intervals, compound resource costs, separate charge conditions/gains, periodic effects, traits, healing, cleansing, knockback and defensive states | Calibrate HP costs, charge semantics/persistence, hitboxes and timing; complete other resource types, percentage limits, shield-break mechanics, multi-shot patterns, specialized/conditional actions, other effects and defense/critical formulas |
| Boss and normal enemies | Source first-Boss attacks, charge, jump and HP gate; armor-state hit caps and untargetable target selection; natural two-gate/Boss run completed with three survivors | Complete other Boss-specific mechanics, remaining damage limits, untargetable exceptions and health-layer counts |
