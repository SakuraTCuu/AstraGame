...
| Skills and damage | Source timelines, homing/directional projectiles and atlas playback, hit budgets/intervals, energy, periodic effects, traits, healing, cleansing, knockback, invulnerability, death protection and one-damage caps | Verify hitboxes, protection/impact timing and projectile wall/orientation rules; complete percentage limits, shield-break mechanics, multi-shot patterns, specialized actions, conditional/team buffs, other effects and defense/critical formulas |
