...
| Skills and damage | Source timelines, homing/directional projectiles, swept contacts, hit budgets and repeat intervals, cached projectile atlas playback, separate energy gains, periodic effects, personal traits, healing, additional skills, cleansing and knockback | Verify hitboxes, energy/trigger/impact timing and projectile wall/orientation rules; complete multi-shot patterns, specialized actions, remaining conditional/team buffs, other effect playback and defense/critical formulas |
