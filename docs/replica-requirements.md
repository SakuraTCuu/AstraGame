...
| Skills and damage | Source skill coefficients/timelines, multi-target projectiles, level-dependent energy, public cooldowns, buffs and critical hits; periodic stacking/settlement and soul/magic/physical damage; equipment and rank stats affect combat | Complete specialized actions, party-wide passives, effect playback, defense/critical formulas and live periodic-damage comparison |
