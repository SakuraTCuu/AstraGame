...
| Skills and damage | Source timelines, projectiles, separate energy gains, periodic stacking/settlement, personal traits, conditional healing, target bonuses, additional skills and NPC-debuff cleansing | Verify live energy/trigger timing; complete specialized actions, remaining conditional/team buffs, effect playback, defense/critical formulas and state classifications |
